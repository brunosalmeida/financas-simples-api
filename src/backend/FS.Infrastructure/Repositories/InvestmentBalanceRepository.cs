namespace FS.Data.Repositories
{
    ...
    public class InvestmentBalanceRepository : IInvestmentBalanceRepository 
    {
        private const string table = "dbo.InvestmentBalance";

        private readonly IConfiguration _configuration;

        public InvestmentBalanceRepository(IConfiguration configuration)
        {
